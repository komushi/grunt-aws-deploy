...
packageLambda.getHandler = function (grunt) {
                    ...
                    mkdirp('./' + options.dist_folder, function (err) {
                        ...
                        dist_zip.on('close', function () {
                            rimraf(install_location, function () {
                                grunt.config.set('deploy_lambda.' + task.target + '.package', dist_path);
                                grunt.config.set('deploy_lambda.' + task.target + '.version', pkg.version);
                                grunt.config.set('deploy_lambda.' + task.target + '.archive_name', archive_name);
                                grunt.config.set('deploy_lambda.' + task.target + '.package_name', pkg.name);
