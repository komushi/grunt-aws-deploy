...
var Q = require('q');
var arnParser = require('./util_arn_parser');
var dateFacade = require('./util_date_facade');

var deployLambda = {};

var proxy = require('proxy-agent');

deployLambda.getHandler = function (grunt) {

    return function () {

        grunt.config.requires('deploy_lambda.' + this.target + '.package');
        ...
        var deploy_function = grunt.config.get('deploy_lambda.' + this.target + '.function');
        var deploy_arn = grunt.config.get('deploy_lambda.' + this.target + '.arn');
        var deploy_package = grunt.config.get('deploy_lambda.' + this.target + '.package');
        var package_version = grunt.config.get('deploy_lambda.' + this.target + '.version');
        var package_name = grunt.config.get('deploy_lambda.' + this.target + '.package_name');
        var archive_name = grunt.config.get('deploy_lambda.' + this.target + '.archive_name');
